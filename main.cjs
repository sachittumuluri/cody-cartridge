...
const isShellSmoke = process.env.CODY_SHELL_SMOKE === "1";
const shellSmokeUserDataPath = isShellSmoke ? process.env.CODY_SHELL_SMOKE_USER_DATA_DIR : "";
...
async function runShellSmoke(mainWindow) {
  ...
  if (process.env.CODY_SHELL_SMOKE_RESET_PROBE === "1") {
